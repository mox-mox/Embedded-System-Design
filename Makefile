...
# adaptions to new directory structure by Maximilian Th�rmer, Mannheim, Germany
# (reduction to support AT91SAM7X256 only)
#
...
# -  2. Nov. 2006  - toolchain-prefix, linker-scripts-path (mth)
# -  3. Apr. 2007 - Reduced support to X256 only, introduced new directory structure

# FORMAT must be ihex (->.hex) for uVision and binary (->.bin) for OpenOCD (see below)
#FLASH_TOOL = UVISION
FLASH_TOOL = OPENOCD
...
#SUBMDL   = AT91SAM7X256
#SUBMDL   = AT91SAM7SE512
#SUBMDL   = AT91RM9200
SUBMDL   = AT91SAM9XE512
...
ASRCARM  = common/csetup.S
#ASRCARM  = common/board_cstartup.S
...
#whether system is supposed to emitt debug output
NOTRACES = 0
